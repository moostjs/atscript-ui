...
| Non-Vue (React/Svelte/Solid port)      | `pnpm add @atscript/ui @atscript/ui-table @atscript/ui-fns` — framework-agnostic core only. Bring your own renderer.   |
...
`AsResolver()` ships from `@atscript/ui-styles/vite`.
