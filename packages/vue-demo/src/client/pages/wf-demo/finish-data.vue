  ...
  <div class="min-h-screen p-$l">
    <div class="max-w-[520px] mx-auto flex flex-col gap-$m">
      ...
      <p class="text-callout text-current/70 m-0">
        ...
        <code>finishWf(&#123; data: &#123; greeting, timestamp &#125;, message &#125;)</code>. No
        <code>next</code> action — the demo overrides <code>#wf.finished</code> to render the typed
        <code>payload.data</code> below the default banner.
      </p>
      <AsWfForm
        path="/api/wf"
