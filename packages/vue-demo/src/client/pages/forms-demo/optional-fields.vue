...
const { def, formData } = createAsFormDef(OptionalFieldsForm);
  ...
  <div class="min-h-screen layer-1">
    <div class="max-w-2xl mx-auto p-$l flex flex-col gap-$l">
      ...
      <AsForm
        ...
        data-testid="optional-fields-form"
        @submit="onSubmit"
      >
      </AsForm>
      ...
      <details class="mt-$l layer-0 border-1 rounded-r2 p-$m text-callout">
        ...
        <pre class="mt-$s overflow-auto text-callout" data-testid="optional-fields-preview">{{
