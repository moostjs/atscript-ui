...
export const componentClasses: Record<string, readonly string[]> = {
  ...
  "as-filters": [
    ...
    "as-filters-overflow-chevron",
    "as-filters-overflow-trigger",
    "as-filters-overflow-trigger-icon",
    "as-narrow:col-span-1",
    "as-narrow:col-span-10",
    "as-narrow:col-span-11",
    "as-narrow:col-span-12",
...
export const componentCompanions: Readonly<
  Partial<Record<AsComponentName, readonly AsComponentName[]>>
> = {
  "as-action-form-dialog": [
    "as-action",
    "as-array",
  ...
  "as-filter-dialog": ["as-config-dialog", "as-filter-input", "as-filters", "as-window-table"],
  "as-filter-field": [
    "as-cell-array",
    "as-cell-date",
    "as-cell-json",
  ...
  "as-filters": ["as-filter-field", "as-residual-filter"],
...
export const helperAliases: Record<string, readonly AsComponentName[]> = {
...
export const componentPackages: Record<string, "form" | "table" | "wf" | "aooth"> = {
  ...
  "as-radio": "form",
  "as-ref": "form",
  "as-residual-filter": "table",
  "as-row-actions": "table",
  "as-select": "form",
  "as-sso-providers": "aooth",
  "as-table": "table",
