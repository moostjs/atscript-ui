...
export const asStructuredShortcuts = defineShortcuts({
  ...
  "as-structured-title": "m-0 font-600 tracking-[-0.005em]",
  "as-structured-remove-btn": {
    "": "inline-flex items-center h-fingertip-s px-$s border-1 bg-transparent text-current/60 rounded-base cursor-pointer text-callout flex-shrink-0 transition-all duration-120 disabled-soft",
