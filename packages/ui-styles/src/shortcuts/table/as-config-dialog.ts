...
export const asConfigDialogShortcuts = defineShortcuts({
  ...
  "as-config-dialog-close": {
    "": "inline-grid place-items-center size-fingertip-s p-0 ml-auto border-0 bg-transparent text-current/80 cursor-pointer leading-none rounded-base flex-shrink-0 transition-colors duration-120 text-[1.25em]",
