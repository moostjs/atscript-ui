...
export const asTableActionsShortcuts = defineShortcuts({
  ...
  "as-table-actions-btn": {
    "": "scope-primary c8-filled inline-flex items-center justify-center gap-$xs h-fingertip-m px-$m font-500 cursor-pointer shrink-0",
    "disabled:": "opacity-40 cursor-not-allowed",
  },
  "as-table-actions-btn-icon": "text-[1.25em] shrink-0",
  "as-table-actions-btn-label": "text-body",
  "as-table-actions-more": {
    "": "scope-neutral c8-chrome inline-flex items-center justify-center h-fingertip-m aspect-square font-600 cursor-pointer shrink-0",
    "disabled:": "opacity-40 cursor-not-allowed",
  },
  ...
  "as-table-actions-menu-separator": "h-[1px] my-$xs bg-scope-light-2 dark:bg-scope-dark-2",
